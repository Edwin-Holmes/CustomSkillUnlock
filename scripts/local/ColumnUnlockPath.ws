...
@addMethod(W3PlayerAbilityManager) private function GetColumnUnlockPairs(): array<ColumnUnlockPair> {
    ...
    // Signs Branch
        // Aard column
    columnUnlock.parentSkill = S_Magic_s20; columnUnlock.childSkill = S_Magic_s01; columnPairs.PushBack(columnUnlock); 
    ...
    columnUnlock.parentSkill = S_Magic_s12; columnUnlock.childSkill = S_Magic_s06; columnPairs.PushBack(columnUnlock);
        // Igni column
    columnUnlock.parentSkill = S_Magic_s08; columnUnlock.childSkill = S_Magic_s02; columnPairs.PushBack(columnUnlock); 
    ...
    columnUnlock.parentSkill = S_Magic_s07; columnUnlock.childSkill = S_Magic_s09; columnPairs.PushBack(columnUnlock);
        // Yrden column
    columnUnlock.parentSkill = S_Magic_s10; columnUnlock.childSkill = S_Magic_s03; columnPairs.PushBack(columnUnlock); 
    ...
    // Alchemy Branch  
        // Potions column  
    columnUnlock.parentSkill = S_Alchemy_s01; columnUnlock.childSkill = S_Alchemy_s02; columnPairs.PushBack(columnUnlock);  
    ...
    columnUnlock.parentSkill = S_Alchemy_s03; columnUnlock.childSkill = S_Alchemy_s04; columnPairs.PushBack(columnUnlock);  
        // Oils column  
    columnUnlock.parentSkill = S_Alchemy_s12; columnUnlock.childSkill = S_Alchemy_s05; columnPairs.PushBack(columnUnlock);  
    ...
    columnUnlock.parentSkill = S_Alchemy_s06; columnUnlock.childSkill = S_Alchemy_s07; columnPairs.PushBack(columnUnlock);  
        // Bombs column  
    columnUnlock.parentSkill = S_Alchemy_s09; columnUnlock.childSkill = S_Alchemy_s10; columnPairs.PushBack(columnUnlock);  
    ...
    columnUnlock.parentSkill = S_Alchemy_s08; columnUnlock.childSkill = S_Alchemy_s11; columnPairs.PushBack(columnUnlock);  
        // Mutagens column  
    columnUnlock.parentSkill = S_Alchemy_s18; columnUnlock.childSkill = S_Alchemy_s13; columnPairs.PushBack(columnUnlock);  
    ...
    columnUnlock.parentSkill = S_Alchemy_s19; columnUnlock.childSkill = S_Alchemy_s14; columnPairs.PushBack(columnUnlock);  
        // Trial of the Grasses column  
    columnUnlock.parentSkill = S_Alchemy_s16; columnUnlock.childSkill = S_Alchemy_s20; columnPairs.PushBack(columnUnlock);  
